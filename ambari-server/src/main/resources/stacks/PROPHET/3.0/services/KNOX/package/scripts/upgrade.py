...
def seed_current_data_directory():
  """
  PROPHET stack example:

  Knox uses "versioned" data directories in some stacks:
  /usr/prophet/2.2.0.0-1234/knox/data -> /var/lib/knox/data
  /usr/prophet/2.3.0.0-4567/knox/data -> /var/lib/knox/data-2.3.0.0-4567
  ...
  cp -R -p -f /usr/prophet/<old>/knox-server/data/. /usr/prophet/current/knox-server/data
  :return:
  """
  import params
