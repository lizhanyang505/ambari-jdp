...
class YARNServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    # YARN
    recommender.recommendYARNConfigurationsFromPROPHET206(configurations, clusterData, services, hosts)
    recommender.recommendYARNConfigurationsFromPROPHET22(configurations, clusterData, services, hosts)
    recommender.recommendYARNConfigurationsFromPROPHET23(configurations, clusterData, services, hosts)
    recommender.recommendYARNConfigurationsFromPROPHET25(configurations, clusterData, services, hosts)
    recommender.recommendYARNConfigurationsFromPROPHET26(configurations, clusterData, services, hosts)
    recommender.recommendYARNConfigurationsFromPROPHET30(configurations, clusterData, services, hosts)
...
class MAPREDUCE2ServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendMapReduce2ConfigurationsFromPROPHET206(configurations, clusterData, services, hosts)
    recommender.recommendMapReduce2ConfigurationsFromPROPHET22(configurations, clusterData, services, hosts)
    recommender.recommendConfigurationsForSSO(configurations, clusterData, services, hosts)
...
class YARNRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendYARNConfigurationsFromPROPHET206(self, configurations, clusterData, services, hosts):
    """
    Recommend configurations for this service based on PROPHET 2.0.6.
    """
    self.logger.info("Class: %s, Method: %s. Recommending Service Configurations." %
                (self.__class__.__name__, inspect.stack()[0][3]))
  ...
  def recommendYARNConfigurationsFromPROPHET22(self, configurations, clusterData, services, hosts):
  ...
  def recommendYARNConfigurationsFromPROPHET23(self, configurations, clusterData, services, hosts):
  ...
  def recommendYARNConfigurationsFromPROPHET25(self, configurations, clusterData, services, hosts):
  ...
  def recommendYARNConfigurationsFromPROPHET26(self, configurations, clusterData, services, hosts):
    putYarnSiteProperty = self.putProperty(configurations, "yarn-site", services)
    putYarnEnvProperty = self.putProperty(configurations, "yarn-env", services)
  ...
  def recommendYARNConfigurationsFromPROPHET30(self, configurations, clusterData, services, hosts):
    putYarnSiteProperty = self.putProperty(configurations, "yarn-site", services)
  ...
  def updateLlapConfigs(self, configurations, services, hosts, llap_queue_name):
    ...
    # This can happen if we upgrade from Ambari 2.4 (with PROPHET 2.5) to Ambari 2.5, as this config is from 2.6 stack onwards only.
  ...
  def get_hive_tez_container_size(self, services):
    ...
    if not hive_container_size:
      ...
      # upgrade scenario from Ambari 2.4 to Ambari 2.5 with PROPHET 2.5 installed. Read it
      # from hive-site.
      #
      # If Ambari 2.5 after upgrade from 2.4 is managing PROPHET 2.6 here, this config would have
      # already been added in hive-interactive-site as part of PROPHET upgrade from 2.5 to 2.6,
...
class MAPREDUCE2Recommender(YARNRecommender):
  ...
  def recommendMapReduce2ConfigurationsFromPROPHET206(self, configurations, clusterData, services, hosts):
  ...
  def recommendMapReduce2ConfigurationsFromPROPHET22(self, configurations, clusterData, services, hosts):
    ...
    self.recommendYARNConfigurationsFromPROPHET206(configurations, clusterData, services, hosts)
    self.recommendYARNConfigurationsFromPROPHET22(configurations, clusterData, services, hosts)
    ...
    putMapredProperty('yarn.app.mapreduce.am.command-opts', "-Xmx" + str(int(0.8 * int(configurations["mapred-site"]["properties"]["yarn.app.mapreduce.am.resource.mb"]))) + "m" + " -Dprophet.version=${prophet.version}")
    servicesList = [service["StackServices"]["service_name"] for service in services["services"]]
...
class YARNValidator(service_advisor.ServiceAdvisor):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.validators = [("yarn-site", self.validateYARNSiteConfigurationsFromPROPHET206),
                       ("yarn-site", self.validateYARNSiteConfigurationsFromPROPHET25),
                       ("yarn-site" , self.validateYARNSiteConfigurationsFromPROPHET26),
                       ("yarn-env", self.validateYARNEnvConfigurationsFromPROPHET206),
                       ("yarn-env", self.validateYARNEnvConfigurationsFromPROPHET22),
                       ("ranger-yarn-plugin-properties", self.validateYARNRangerPluginConfigurationsFromPROPHET22)]
  ...
  def validateYARNSiteConfigurationsFromPROPHET206(self, properties, recommendedDefaults, configurations, services, hosts):
    """
    This was copied from PROPHET 2.0.6; validate yarn-site
    :return: A list of configuration validation problems.
    """
  ...
  def validateYARNSiteConfigurationsFromPROPHET25(self, properties, recommendedDefaults, configurations, services, hosts):
    yarn_site_properties = self.getSiteProperties(configurations, "yarn-site")
    validationItems = []
  ...
  def validateYARNSiteConfigurationsFromPROPHET26(self, properties, recommendedDefaults, configurations, services, hosts):
    validationItems = []
  ...
  def validateYARNEnvConfigurationsFromPROPHET206(self, properties, recommendedDefaults, configurations, services, hosts):
    """
    This was copied from PROPHET 2.0.6; validate yarn-env
    :return: A list of configuration validation problems.
    """
  ...
  def validateYARNEnvConfigurationsFromPROPHET22(self, properties, recommendedDefaults, configurations, services, hosts):
    """
    This was copied from PROPHET 2.2; validate yarn-env
    :return: A list of configuration validation problems.
    """
    validationItems = []
  ...
  def validateYARNRangerPluginConfigurationsFromPROPHET22(self, properties, recommendedDefaults, configurations, services, hosts):
    """
    This was copied from PROPHET 2.2; validate ranger-yarn-plugin-properties
    :return: A list of configuration validation problems.
    """
    validationItems = []
...
class MAPREDUCE2Validator(service_advisor.ServiceAdvisor):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.validators = [("mapred-site", self.validateMapReduce2SiteConfigurationsFromPROPHET206),
                       ("mapred-site", self.validateMapReduce2SiteConfigurationsFromPROPHET22)]
  ...
  def validateMapReduce2SiteConfigurationsFromPROPHET206(self, properties, recommendedDefaults, configurations, services, hosts):
    """
    This was copied from PROPHET 2.0.6; validate mapred-site
    :return: A list of configuration validation problems.
    """
  ...
  def validateMapReduce2SiteConfigurationsFromPROPHET22(self, properties, recommendedDefaults, configurations, services, hosts):
    """
    This was copied from PROPHET 2.2; validate mapred-site
    :return: A list of configuration validation problems.
    """
    validationItems = [ {"config-name": 'mapreduce.map.java.opts', "item": self.validateXmxValue(properties, recommendedDefaults, 'mapreduce.map.java.opts')},
                        {"config-name": 'mapreduce.reduce.java.opts', "item": self.validateXmxValue(properties, recommendedDefaults, 'mapreduce.reduce.java.opts')},
