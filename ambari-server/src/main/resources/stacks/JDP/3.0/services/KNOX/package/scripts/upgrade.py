...
def seed_current_data_directory():
  ...
  /usr/jdp/2.2.0.0-1234/knox/data -> /var/lib/knox/data
  /usr/jdp/2.3.0.0-4567/knox/data -> /var/lib/knox/data-2.3.0.0-4567
  ...
  cp -R -p -f /usr/jdp/<old>/knox-server/data/. /usr/jdp/current/knox-server/data
  :return:
  """
  import params
