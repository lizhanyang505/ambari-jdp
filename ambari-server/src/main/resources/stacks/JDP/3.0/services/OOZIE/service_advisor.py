...
class OozieServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendOozieConfigurationsFromJDP30(configurations, clusterData, services, hosts)
...
class OozieRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendOozieConfigurationsFromJDP30(self, configurations, clusterData, services, hosts):
    ## added in 2.0.6
