...
class YARNServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    # YARN
    recommender.recommendYARNConfigurationsFromJDP206(configurations, clusterData, services, hosts)
    recommender.recommendYARNConfigurationsFromJDP22(configurations, clusterData, services, hosts)
    recommender.recommendYARNConfigurationsFromJDP23(configurations, clusterData, services, hosts)
    recommender.recommendYARNConfigurationsFromJDP25(configurations, clusterData, services, hosts)
    recommender.recommendYARNConfigurationsFromJDP26(configurations, clusterData, services, hosts)
    recommender.recommendYARNConfigurationsFromJDP30(configurations, clusterData, services, hosts)
...
class MAPREDUCE2ServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    recommender.recommendMapReduce2ConfigurationsFromJDP206(configurations, clusterData, services, hosts)
    recommender.recommendMapReduce2ConfigurationsFromJDP22(configurations, clusterData, services, hosts)
    recommender.recommendConfigurationsForSSO(configurations, clusterData, services, hosts)
...
class YARNRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendYARNConfigurationsFromJDP206(self, configurations, clusterData, services, hosts):
    """
  ...
  def recommendYARNConfigurationsFromJDP22(self, configurations, clusterData, services, hosts):
  ...
  def recommendYARNConfigurationsFromJDP23(self, configurations, clusterData, services, hosts):
  ...
  def recommendYARNConfigurationsFromJDP25(self, configurations, clusterData, services, hosts):
  ...
  def recommendYARNConfigurationsFromJDP26(self, configurations, clusterData, services, hosts):
    putYarnSiteProperty = self.putProperty(configurations, "yarn-site", services)
    putYarnEnvProperty = self.putProperty(configurations, "yarn-env", services)
  ...
  def recommendYARNConfigurationsFromJDP30(self, configurations, clusterData, services, hosts):
    putYarnSiteProperty = self.putProperty(configurations, "yarn-site", services)
  ...
  def updateLlapConfigs(self, configurations, services, hosts, llap_queue_name):
    ...
    # This can happen if we upgrade from Ambari 2.4 (with JDP 2.5) to Ambari 2.5, as this config is from 2.6 stack onwards only.
...
class MAPREDUCE2Recommender(YARNRecommender):
  ...
  def recommendMapReduce2ConfigurationsFromJDP206(self, configurations, clusterData, services, hosts):
  ...
  def recommendMapReduce2ConfigurationsFromJDP22(self, configurations, clusterData, services, hosts):
    ...
    self.recommendYARNConfigurationsFromJDP206(configurations, clusterData, services, hosts)
    self.recommendYARNConfigurationsFromJDP22(configurations, clusterData, services, hosts)
    ...
    putMapredProperty('yarn.app.mapreduce.am.command-opts', "-Xmx" + str(int(0.8 * int(configurations["mapred-site"]["properties"]["yarn.app.mapreduce.am.resource.mb"]))) + "m" + " -Djdp.version=${jdp.version}")
    servicesList = [service["StackServices"]["service_name"] for service in services["services"]]
...
class YARNValidator(service_advisor.ServiceAdvisor):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.validators = [("yarn-site", self.validateYARNSiteConfigurationsFromJDP206),
                       ("yarn-site", self.validateYARNSiteConfigurationsFromJDP25),
                       ("yarn-site" , self.validateYARNSiteConfigurationsFromJDP26),
                       ("yarn-env", self.validateYARNEnvConfigurationsFromJDP206),
                       ("yarn-env", self.validateYARNEnvConfigurationsFromJDP22),
                       ("ranger-yarn-plugin-properties", self.validateYARNRangerPluginConfigurationsFromJDP22)]
  ...
  def validateYARNSiteConfigurationsFromJDP206(self, properties, recommendedDefaults, configurations, services, hosts):
    """
    This was copied from JDP 2.0.6; validate yarn-site
    :return: A list of configuration validation problems.
    """
  ...
  def validateYARNSiteConfigurationsFromJDP25(self, properties, recommendedDefaults, configurations, services, hosts):
    yarn_site_properties = self.getSiteProperties(configurations, "yarn-site")
    validationItems = []
  ...
  def validateYARNSiteConfigurationsFromJDP26(self, properties, recommendedDefaults, configurations, services, hosts):
    validationItems = []
  ...
  def validateYARNEnvConfigurationsFromJDP206(self, properties, recommendedDefaults, configurations, services, hosts):
    """
    This was copied from JDP 2.0.6; validate yarn-env
    :return: A list of configuration validation problems.
    """
  ...
  def validateYARNEnvConfigurationsFromJDP22(self, properties, recommendedDefaults, configurations, services, hosts):
    """
    This was copied from JDP 2.2; validate yarn-env
    :return: A list of configuration validation problems.
    """
    validationItems = []
  ...
  def validateYARNRangerPluginConfigurationsFromJDP22(self, properties, recommendedDefaults, configurations, services, hosts):
    """
    This was copied from JDP 2.2; validate ranger-yarn-plugin-properties
    :return: A list of configuration validation problems.
    """
    validationItems = []
...
class MAPREDUCE2Validator(service_advisor.ServiceAdvisor):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.validators = [("mapred-site", self.validateMapReduce2SiteConfigurationsFromJDP206),
                       ("mapred-site", self.validateMapReduce2SiteConfigurationsFromJDP22)]
  ...
  def validateMapReduce2SiteConfigurationsFromJDP206(self, properties, recommendedDefaults, configurations, services, hosts):
    """
    This was copied from JDP 2.0.6; validate mapred-site
    :return: A list of configuration validation problems.
    """
  ...
  def validateMapReduce2SiteConfigurationsFromJDP22(self, properties, recommendedDefaults, configurations, services, hosts):
    """
    This was copied from JDP 2.2; validate mapred-site
    :return: A list of configuration validation problems.
    """
    validationItems = [ {"config-name": 'mapreduce.map.java.opts', "item": self.validateXmxValue(properties, recommendedDefaults, 'mapreduce.map.java.opts')},
                        {"config-name": 'mapreduce.reduce.java.opts', "item": self.validateXmxValue(properties, recommendedDefaults, 'mapreduce.reduce.java.opts')},
